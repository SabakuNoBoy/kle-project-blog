...
<body class="bg-gray-50 flex items-center justify-center min-h-screen">
    <div class="max-w-md w-full px-6 py-12 bg-white shadow-xl rounded-2xl text-center border border-gray-100">
        ...
        <h1 class="text-3xl font-bold text-gray-900 mb-4">Yetki Hatası</h1>
        <p class="text-gray-500 mb-8">Bu alana girmeye veya bu işlemi yapmaya yetkiniz bulunmamaktadır. Lütfen yönetici
            hesabıyla giriş yapın.</p>
